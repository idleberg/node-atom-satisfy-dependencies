 ...
 */
function satisfyDependencies(packageName, userOptions) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, atom_read_manifest_1.readManifest(packageName)];
                case 1:
                    manifest = _a.sent();
                    atom_package_deps_1.install(manifest.name, options.showPrompt);
...
function enableDependencies(manifest, options) {
    if (options.enableDependencies) {
        manifest['package-deps'].forEach(function (packageDependency) {
