...
var satisfyDependencies = function (packageName, showPrompt) {
    if (showPrompt === void 0) { showPrompt = true; }
    return __awaiter(void 0, void 0, void 0, function () {
        var manifest;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, atom_read_manifest_1.readManifest(packageName)];
                case 1:
                    manifest = _a.sent();
                    atom_package_deps_1.install(packageName, showPrompt);
